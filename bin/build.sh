...
echo "Building docker.viriciti.com/viriciti/app-layer/app-layer-control:${VERSION} ..."
docker build -t docker.viriciti.com/viriciti/app-layer/app-layer-control:${VERSION} .
...
docker push docker.viriciti.com/viriciti/app-layer/app-layer-control:${VERSION}
